"""
Django settings for weathered_grass_42573 project.
...
ROOT_URLCONF = 'weathered_grass_42573.urls'
...
WSGI_APPLICATION = 'weathered_grass_42573.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "weathered_grass_42573 API",
    "DESCRIPTION": "API documentation for weathered_grass_42573 App",
    "VERSION": "v1",
}

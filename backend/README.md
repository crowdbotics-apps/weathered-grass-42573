...
## Project Structure
    ...
    ├── weathered_grass_42573  # Django project configurations
...
1. Clone this repo and `cd weathered_grass_42573`
...
2. Clone this repo and `cd weathered_grass_42573`
